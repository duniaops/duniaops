...
| `/blog/can-a-new-company-maintain-software-it-did-not-build` | New support-takeover buyer article | 11 Sep 2026 | 18 Sep | 25 Sep | 9 Oct | Unknown to Google/not indexed on 14 Sep; no crawl or referring sitemap reported; live sitemap contains URL | Yes — support-preselected enquiry CTA verified; commercial parent link live 14 Sep | `596bd6a`; production deploy `6aa3ded37934dd0008b0273d` | Hold and recheck 18 Sep |
| `/services/application-support-maintenance` | New commercial support service | 14 Sep 2026 | 21 Sep | 28 Sep | 12 Oct | First Search Console inspection due 21 Sep; no request-indexing action made at publication | Yes — live support CTA, homepage card, parent/article link and sitemap verified | `391212f`; production deploy `6aa7c66397876156ed30ef9f` | Hold and observe |
